class PlaylistDetails {
  String? href;
  List<ItemsPlaylistDetails>? items;
  int? limit;
  String? next;
  int? offset;
  Null? previous;
  ...
  PlaylistDetails.fromJson(Map<String, dynamic> json) {
    href = json['href'];
    if (json['items'] != null) {
      items = <ItemsPlaylistDetails>[];
      json['items'].forEach((v) {
        items!.add(new ItemsPlaylistDetails.fromJson(v));
      });
    }
    limit = json['limit'];
    next = json['next'];
...
class ItemsPlaylistDetails {
  ...
  ItemsPlaylistDetails.fromJson(Map<String, dynamic> json) {
